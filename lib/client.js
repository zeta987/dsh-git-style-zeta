  ...
  factory: (require) => {
    ...
    const STRINGS = {
      en: {
        ...
        commitPlaceholder: 'Use Conventional Commits with a concise subject and explain why.\nAdd Co-authored-by: Name <email> only when it is absent.',
        ...
        prPlaceholder: 'Describe the problem, resulting behavior, and checks actually run.\nPreserve existing attribution and hidden template markers.',
      ...
      zh: {
        ...
        commitPlaceholder: '使用 Conventional Commits，標題精簡並說明原因。\n只有在缺少時才加入 Co-authored-by: Name <email>。',
        prLabel: 'Pull request 指令',
        prHint: '原文加入「Git pull request instructions」提示區段。留空則不加入任何內容。',
        prPlaceholder: '說明問題、最後的行為，以及實際跑過的檢查。\n保留既有署名與隱藏的樣板標記。',
        sectionOn: '提示區段已開啟',
        sectionOff: '提示區段未開啟',
        overridden: '在此設定',
